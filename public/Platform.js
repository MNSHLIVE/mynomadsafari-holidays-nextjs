...
, function(e, t) {
    ...
    function o(e, t) {
        if (e) {
            ...
            return "Object" === n || "Map" === n || "Set" === n ? Array.from(e) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? r(e, t) : void 0
        }
    }
    function r(e, t) {
        ...
        if (null != n) {
            ...
            try {
                ...
                0 === t) {
                    ...
                    for (; !(l = (i = r.call(n)).done) && (s.push(i.value),
                    s.length !== t); l = !0)
                        ;
            } catch (e) {
                c = !0,
    ...
    e.exports = function() {
        ...
        e.i = function(t, n) {
            ...
            for (o = 0; o < t.length; o++) {
                var a = t[o];
                "number" == typeof a[0] && i[a[0]] ? t.splice(o--, 1) : (n && !a[2] ? a[2] = n : n && (a[2] = "(" + a[2] + ") and (" + n + ")"),
                e.push(a))
            }
        }
        ,
