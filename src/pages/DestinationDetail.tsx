...
const DestinationDetail = () => {
  ...
  const destination = [...indianDestinations, ...internationalDestinations]
    .find(dest => dest.state?.toLowerCase() === formattedName?.toLowerCase() || 
                  dest.country?.toLowerCase() === formattedName?.toLowerCase());
    ...
    <div className="container mx-auto px-4 pt-24 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-2xl font-bold mb-4">About {destination.state || destination.country}</h2>
        ...
        <div className="lg:col-span-1">
          <div className="bg-card p-6 rounded-xl shadow-sm">
            ...
            <DestinationQueryForm 
              destinationName={destination.state || destination.country} 
